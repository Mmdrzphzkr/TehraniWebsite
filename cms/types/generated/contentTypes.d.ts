...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publicationStatus: Schema.Attribute.Enumeration<['DRAFT', 'PUBLISHED']> &
...
export interface ApiCourseSessionCourseSession
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    courseWorkshop: Schema.Attribute.Relation<
      'manyToOne',
      'api::course-workshop.course-workshop'
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiCourseWorkshopCourseWorkshop
  extends Struct.CollectionTypeSchema {
  collectionName: 'course_workshops';
  info: {
    displayName: 'CourseWorkshop';
    pluralName: 'course-workshops';
    singularName: 'course-workshop';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    publicationStatus: Schema.Attribute.Enumeration<['DRAFT', 'PUBLISHED']> &
      Schema.Attribute.DefaultTo<'DRAFT'>;
    publishedAt: Schema.Attribute.DateTime;
    remainingCapacity: Schema.Attribute.Integer;
    seo: Schema.Attribute.JSON;
    ...
    title: Schema.Attribute.String & Schema.Attribute.Required;
    totalCapacity: Schema.Attribute.Integer;
    type: Schema.Attribute.Enumeration<['COURSE', 'WORKSHOP']> &
...
export interface ApiFounderFounder extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    flexibleBlocks: Schema.Attribute.DynamicZone<
      ['webpages.image-block', 'webpages.text-block']
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiInstructorCategoryInstructorCategory
  extends Struct.CollectionTypeSchema {
  collectionName: 'instructor_categories';
  info: {
    displayName: 'Instructor Category';
    pluralName: 'instructor-categories';
    singularName: 'instructor-category';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::instructor-category.instructor-category'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiInstructorInstructor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    professionalExperience: Schema.Attribute.RichText;
    publicationStatus: Schema.Attribute.Enumeration<['DRAFT', 'PUBLISHED']> &
      Schema.Attribute.DefaultTo<'DRAFT'>;
    publishedAt: Schema.Attribute.DateTime;
    ...
    teachingExperience: Schema.Attribute.RichText;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiMediaItemMediaItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    mediaType: Schema.Attribute.Enumeration<
      ['VIDEO', 'AUDIO', 'IMAGE', 'INTERVIEW', 'EDUCATIONAL', 'OTHER']
    > &
    ...
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'title'>;
    sourceMode: Schema.Attribute.Enumeration<['UPLOAD', 'EXTERNAL_URL']> &
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    uploadedAsset: Schema.Attribute.Media;
  };
}
...
export interface ApiRentalPageRentalPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    contentProductionStudio: Schema.Attribute.RichText;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    directCallCTA: Schema.Attribute.String;
    equipmentRentalDescription: Schema.Attribute.RichText;
    ...
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.JSON;
    spaceRentalDescription: Schema.Attribute.RichText;
    trainingHall: Schema.Attribute.RichText;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiRequestRequest extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    relatedCourseWorkshop: Schema.Attribute.Relation<
      'manyToOne',
      'api::course-workshop.course-workshop'
    >;
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    globalSeo: Schema.Attribute.JSON;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiUserUser extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    mobile: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    mobileVerifiedAt: Schema.Attribute.DateTime;
    nationalIdEncrypted: Schema.Attribute.Text;
    nationalIdHash: Schema.Attribute.String & Schema.Attribute.Unique;
    otpVerified: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    publishedAt: Schema.Attribute.DateTime;
    role: Schema.Attribute.Enumeration<
      ['USER', 'REQUEST_ADMIN', 'SUPER_ADMIN']
    > &
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ContentTypeSchemas {
      ...
      'api::course-workshop.course-workshop': ApiCourseWorkshopCourseWorkshop;
      'api::event-category.event-category': ApiEventCategoryEventCategory;
      'api::event.event': ApiEventEvent;
      'api::founder.founder': ApiFounderFounder;
      'api::homepage.homepage': ApiHomepageHomepage;
      'api::instructor-category.instructor-category': ApiInstructorCategoryInstructorCategory;
